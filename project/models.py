...
# loan update history with db database
class Loan_update_history(db.Model):
    ...
    def __init__(self,loan_amount,duration,loan_id,state=LOAN_STATUS['New'],loan_type=loan_type['Home_loan']):
...
#class for loan with model database arguments
class Loan(db.Model):
    __tablename__="Loans"
...
class Users(db.Model):
    ...
    username=db.Column(db.String(64),index=True,nullable=False,unique=False)
